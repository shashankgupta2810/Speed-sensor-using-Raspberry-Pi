...
if __name__ == '__main__':
    ...
    init_interrupt()
    while True:
        print(calculate_speed(20)) # call this function with wheel radius as parameter ,20 is given for how many holes in wheel
        print('kmh:{1:.0f}-KMH' .format(rpm,km_per_hour))
